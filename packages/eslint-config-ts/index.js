 ...
 * @link https://www.npmjs.com/package/eslint-plugin-unused-imports
 */
...
module.exports = {
    parserOptions: {
        ...
        ecmaVersion: 2020, // 代表 ECMAScript 2020（也被称为 ES11）规范
        sourceType: "module", //  代码是 ES6 模块，因此应该解析 ES6 的 import 和 export 语句。
        ecmaFeatures: {
            globalReturn: false, // 在全局作用域中不允许使用 return 语句
            impliedStrict: true,
            jsx: true, // 表示代码包含 JSX 语法，这通常用于 React 组件。
        },
    },
    root: true,
    ignorePatterns: ["dist/", "build/",'public/', "src/assets", "**/*.min.js", "**/*.md"],
